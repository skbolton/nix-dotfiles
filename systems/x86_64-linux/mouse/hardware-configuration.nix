...

{
  ...
  boot.initrd.luks.devices."system".device = "/dev/disk/by-partlabel/BEE-SYSTEM";
  ...
  fileSystems."/var/zion-data" =
    {
      device = "/dev/disk/by-label/NIX-SYSTEM";
      fsType = "btrfs";
      options = [ "subvol=@var/zion-data" "compress=zstd" "ssd" "noatime" "space_cache=v2" ];
    };
