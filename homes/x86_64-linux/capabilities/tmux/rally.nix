...
writeShellScriptBin "rally.sh" ''
  set -eu
  TARGET=$(ls -d ~/Public/* ~/* | ${fzf}/bin/fzf --header-first --header="Launch Project" --prompt="󰑣 " --pointer="·" --preview '${eza}/bin/eza --tree --icons --level 3 --git-ignore {}' --delimiter '/' --with-nth -2..-1)
